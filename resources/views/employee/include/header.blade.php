            ...
            <div class="p-4 pt-1">
                ...
                <ul class="list-unstyled components mb-5">
                    <li>
                        ...
                        <a href="{{url('/homeEmployee')}}"><span class="fa fa-home mr-3"></span>Home</a>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="insSubmenu">
                            <li>
                                <a href="{{url('/InstalmentEmployee')}}"><span
                                        class="fa fa-caret-right mr-3"></span>Installment</a>
                            </li>
                            <li>
                                <a href="{{url('/requestEmployee')}}"><span class="fa fa-caret-right mr-3"></span>Request <span
                    ...
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="requestProduct">
                            <li>
                                <a href="{{url('/blogIndexEmployee')}}"><span
                    ...
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="settSubmenu">
                            <li>
                            <form action="{{ route('logoutEmployee') }}" method="POST" style="display: inline"
