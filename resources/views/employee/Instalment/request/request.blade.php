            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-primary">
                        ...
                        <a href="{{url('/requestAddEmployee')}}"><button type="button" class="btn btn-primary "
                            ...
                            <table class="table" id="myTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$req->r_date}}</td>
                                        <td><a href="{{url('/requestApprovalEmployee',$req->r_id)}}">Approve</a> | <form action="{{ url('/requestDeleteEmployee', $req->r_id) }}" method="POST" class="delete-form" style="display: inline">
                                            @csrf
                                            @method('DELETE')
