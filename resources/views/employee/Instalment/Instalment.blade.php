                            ...
                            <table class="table" id="myTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{url('/paymentEmployee',$item->i_id)}}">Show</a> |<form action="{{ url('/instalmentDeleteHandlerEmployee', $item->i_id) }}" method="POST" class="delete-form" style="display: inline">
                                            @csrf
                                            @method('DELETE')
