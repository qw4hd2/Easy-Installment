        ...
        <nav id="sidebar">
            <div class="p-4 pt-1">
                ...
                <ul class="list-unstyled components mb-5">
                    ...
                    <li>
                        <a href="#proSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><span
                                class="fa fa-inbox mr-3"></span>Product</a>
                        <ul class="collapse list-unstyled" id="proSubmenu">
                            <li>
                                <a href="{{url('/stock')}}"><span class="fa fa-caret-right mr-3"></span>Stock</a>
                            </li>
                            <li>
                                <a href="{{url('/supplier')}}"><span class="fa fa-caret-right mr-3"></span>Supplier</a>
                            </li>
                            <li>
                                <a href="{{url('/category')}}"><span class="fa fa-caret-right mr-3"></span>Category</a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="insSubmenu">
                            <li>
                                <a href="{{url('costumer')}}"><span class="fa fa-caret-right mr-3"></span>Costumer</a>
                            </li>
                            <li>
                                <a href="{{url('/Instalment')}}"><span
                                        class="fa fa-caret-right mr-3"></span>Installment</a>
                            </li>
                            <li>
                                <a href="{{url('/request')}}"><span class="fa fa-caret-right mr-3"></span>Request <span
                    ...
                    <li>
                        <a href="{{url('/expenses')}}"><span class="fa fa-info-circle mr-3"></span>Expenses</a>
                    </li>

                    <li>
                        <a href="#repSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><span
                                class="fa fa-inbox mr-3"></span>Report</a>
                        <ul class="collapse list-unstyled" id="repSubmenu">
                            <li>
                                <a href="{{url('/stockReport')}}"><span class="fa fa-caret-right mr-3"></span>Stock
                                    Report</a>
                            </li>
                            <li>
                                <a href="{{url('/paymentListPending')}}"><span
                                        class="fa fa-caret-right mr-3"></span>Costumer
                                    Report</a>
                            </li>
                            <!-- <li>
                    ...
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="settSubmenu">
                            ...
                            <li>
                                <a href="{{url('/user')}}"><span class="fa fa-caret-right mr-3"></span>Manage User</a>
                            </li>
                            <li>
